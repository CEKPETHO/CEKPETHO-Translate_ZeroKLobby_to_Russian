return {
	...
	ru = {
		...
		queues = "Очереди",
		custom_games = "Custom игры",
		spectate_running_games = "Выбрать игру для просмотра",
		social = "Социальное",
		hub = "Хаб",
		download = "Скачать",
		downloads = "Загрузки",
		...
		battle = "Battle",
		dont_have_map = "Нет карты",
		dont_have_game = "Нет игры",
		have_game = "Есть игра",
		have_map = "Есть карта",
		start = "Старт",
		...
		watch = "Смотреть",
		matchmaking = "Подбор игры",
		customGames = "Пользовательские игры",
		playing = "Играет",
		pick_map = "Выбрать карту",
		...
		select_maps = "Выбрать карты в бан",
		users = "Пользователи",
		battles = "Битвы",
		time_to_respond = "Время на ответ",
		are_you_ready = "Готов?",
		seconds_short = "с",
		not_ready_leaving_queue = "Не готов, выход из очереди",
		waiting_for_other_players = "Ожидание других игроков",
		game_starting_soon = "Игра скоро начнётся",
		timeout_leaving_queue = "Время ожидания истекло, выход из очереди",
		items_to_download = {
			one = "Oстался один файл для скачивания.",
			other = "%{count} осталось скачать.",
		},
		downloads_completed = "Все загрузки завершены.",
		type_to_filter = "Введите текст для фильтрации",

		-- gui_maplist_panel.lua
		click_to_pick_map = "Щёлкните, чтобы выбрать эту карту.",
		click_to_download_map = "Щёлкните, чтобы скачать эту карту.",

		-- Settings
		planetwars_notifications = "Уведомления планетарных войн",
		ingame_notifcations = "Уведомления во время игры",
		non_friend_notifications = "Уведомления от не-друзей",
		notifyForAllChat = "Уведомления для всего чата",
		hideWelcomeMessage = "Скрыть приветственную подсказку обученияt",
		drawFullSpeed = "Обновление отрисовки на полной скорости",
		keep_queues = "Оставаться в очередях МП при запуске",
		simplifiedSkirmishSetup = "Простая настройка схватки",
		debugMode = "Режим откладки",
		animate_lobby = "Анимации лобби",
		...
		chat = "Чат",
		join = "Присоединиться",
		attack_planet = "Атаковать планету",
		defend_planet = "Защитить планету",
		...
		invited_to_team = "Приглашён в команду",
		invites_you_to_join_team = " пригласил(-а) Вас в команду",
		joined_team = " присоединился(-ась) к игре",
		join_team = "Вы присоединились к команде",
		declined_invite_team = " отклонил(-а) приглашение присоединиться к команде",

		-- api_user_handler.lua
		offline_status = "Не в сети",
		ingame_status  = "В игре",
		battle_status  = "В битве",
		afk_status     = "Отошёл(-ла)",
		...
		save = "Сохранить",
		save_new_game = "Сохранить новую игру",
		save_name = "Название сохранения",
		commander_name = "Имя коммандера",
		configure_commander = "Настроить коммандера",
		commander = "Коммандер",
		save_overwrite_confirm = "Вы уверены, что хотите перезаписать это сохранение?",
		autosave = "Автосохранение",
		new_campaign = "Новая компания",
		["load"] = "Загрузить",
		load_confirm = "Загрузка приведёт к потере несохранённого прогресса. Вы уверены?",
		delete = "Удалить",
		delete_confirm = "Вы уверены, что хотите удалить это сохранение?",
		saveload = "Сохранить / Загрузить",
		quit_confirm = "Выход приведёт к потере несохранённого прогресса. Вы уверены?",
		...
		-- gui_rank_update_window.lua
		rank_gained = "Звание повышено",
		rank_lost = "Звание понижено",

		advanced_button_tooltip = [[Полная настройка параметров игры. Активация автоматического расширенного режима отключив "Простая настройка схватки" в настройках лобби.]],
